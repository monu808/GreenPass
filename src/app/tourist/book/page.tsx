            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-6">
              ...
              <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto border-t sm:border-t-0 pt-4 sm:pt-0 border-gray-50">
                <div className="flex flex-col items-start sm:items-end">
                  ...
                  <span className={`text-xs font-bold mt-1 ${availability.text === 'Fully Booked' ? 'text-red-500' : 'text-green-500'
                    }`}>
                    {capacityResult?.displayMessage || availability.text}
                  </span>
                </div>

                <div className={`flex items-center px-4 py-2 rounded-full border shadow-sm mt-0 sm:mt-4 ${destination.ecologicalSensitivity === 'critical' ? 'bg-red-50 border-red-100 text-red-600' :
