    ...
    for (const field of emergencyRequired) {
      if (
        !formData.emergencyContact[
          field as keyof typeof formData.emergencyContact
        ]
      ) {
        return false;
      }
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-blue-800">
                {destination.maxCapacity - destination.currentOccupancy} spots
                available out of {destination.maxCapacity}
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  max={
                    formData.checkOutDate ? formData.checkOutDate : undefined
                  }
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900"
                />
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600">
                  By submitting this form, you agree to follow all destination
