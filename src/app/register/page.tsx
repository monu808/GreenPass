...
export default function RegisterTourist() {
  ...
  const sanitizeFormData = (data: typeof formData) => {
    return {
      ...
      groupSize: typeof data.groupSize === 'number' ? data.groupSize : safeParseInt(data.groupSize, 1),
    };
  };
  ...
  const validateForm = (step?: number): boolean => {
    ...
    if (targetStep === 1 || !step) {
      const registrationResult = validateInput(TouristRegistrationSchema, {
        ...
        age: safeParseInt(sanitizedData.age, 0),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingData: Database['public']['Tables']['tourists']['Insert'] = {
        name: sanitizedData.name,
        email: sanitizedData.email,
        phone: normalizedPhone,
        age: safeParseInt(sanitizedData.age, 0),
        gender: sanitizedData.gender as any,
        address: sanitizedData.address,
        pin_code: sanitizedData.pinCode,
        id_proof_type: sanitizedData.idProofType as any,
        id_proof: sanitizedData.idProof,
        nationality: sanitizedData.nationality,
        group_name: sanitizedData.group_name,
        destination_id: sanitizedData.destination,
          ...
          <div className="mt-6 flex items-center justify-between relative">
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="relative z-10 flex flex-col items-center">
                ...
                <span className={`mt-2 text-xs font-bold uppercase tracking-wider ${currentStep === step ? 'text-green-600' : 'text-gray-400'
                  }`}>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6" noValidate aria-label="Tourist registration form">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.name ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.email ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.phone ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.age}
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.age ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.gender ? 'border-red-600' : 'border-gray-300'
                        }`}
                      aria-label="Gender"
                      aria-required="true"
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.address ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.pinCode ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.idProofType ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.idProof ? 'border-red-600' : 'border-gray-300'
                        }`}
                      placeholder={
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.group_name ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.groupSize ? 'border-red-600' : 'border-gray-300'
                        }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.destination ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.checkInDate ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.checkOutDate ? 'border-red-600' : 'border-gray-300'
                        }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.emergencyContactName ? 'border-red-600' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.emergencyContactPhone ? 'border-red-600' : 'border-gray-300'
                        }`}
                      placeholder="+91 98765 43210 or 9876543210"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 min-h-[52px] border rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none focus:border-transparent text-gray-900 ${errors.emergencyContactRelationship ? 'border-red-600' : 'border-gray-300'
                        }`}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-100">
              <button
                ...
                className={`w-full sm:w-auto px-8 py-3 rounded-xl font-bold text-sm transition-all min-h-[44px] flex items-center justify-center ${currentStep === 1
